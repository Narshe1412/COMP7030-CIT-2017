...
public class myListLinkedListBool implements myListBool {

	//--------------------------------------------------
	// Attributes
	//--------------------------------------------------
	private myNodeBool head; 
	...
	//-------------------------------------------------------------------
	public void my_add_element(int index, boolean element){
		//1. We declare the reference nodes
		myNodeBool current_node = head;
		myNodeBool previous_node = null;
		int count = 0;
		...
		if (count == index){
			...
			myNodeBool new_node = new myNodeBool(element, null);
