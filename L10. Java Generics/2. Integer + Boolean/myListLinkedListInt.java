...
public class myListLinkedListInt implements myListInt {

	//--------------------------------------------------
	// Attributes
	//--------------------------------------------------
	private myNodeInt head; 
	...
	public void my_add_element(int index, int element){
		//1. We declare the reference nodes
		myNodeInt current_node = head;
		myNodeInt previous_node = null;
		int count = 0;
		...
		if (count == index){
			...
			myNodeInt new_node = new myNodeInt(element, null);
